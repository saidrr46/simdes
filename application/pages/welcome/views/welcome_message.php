							...
							<!-- <div class="header-column">
								<div class="header-row">
									<div class="header-logo">
                                        ...
                                        <img alt="simdes" class="></a>
									</div>
								</div>
							</div> -->
							<div class="header-column justify-content-end">
								<div class="header-row">
									<div class="header-nav header-nav-links header-nav-dropdowns-dark header-nav-light-text order-2 order-lg-1" style="background-image:url('img/ironlogo.jpg');background-size:cover;background-position:center">
										<div class="header-nav-main header-nav-main-mobile-dark header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													<li>
														<a class="dropdown-item" data-hash data-hash-offset="68" href="#Home">Home</a>
													</li>
													<li class="dropdown">
														<a data-hash class="dropdown-item dropdown-toggle active" href="#Profile">Profile</a>
														<ul class="dropdown-menu">
															<li><a class="dropdown-item" href="index-classic.html">Sejarah</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">Visi & Misi</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">Demografi</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">Potensi</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">Peta Desa</a></li>
														</ul>
													</li>
													<li class="dropdown">
                                                        <a data-hash class="dropdown-item dropdown-toggle active" href="#Berita">Berita</a>
                                                        <ul class="dropdown-menu">
															<li><a class="dropdown-item" href="index-classic.html">Kabar Desa</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">Opini</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">Artikel</a></li>
														</ul>
													</li>
													<li class="dropdown">
                                                        <a data-hash class="dropdown-item dropdown-toggle active" href="#Statistik">Statistik</a>
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item" href="index-classic.html">Agama Penduduk</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">Jenis Kelamin</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">Usia Penduduk</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">Pekerjaan Penduduk</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">Pendidikan Penduduk</a></li>
                                                        </ul>
													</li>
													<li class="dropdown">
                                                        <a data-hash class="dropdown-item dropdown-toggle active" href="#Lembaga">Lembaga</a>
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item" href="index-classic.html">Stak Desa</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">BPD</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">LPMD</a></li>
                                                            <li><a class="dropdown-item" href="index-one-page.html">TP.PKK</a></li>
                                                        </ul>
													</li>
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															<li class="dropdown-submenu">
																<a class="dropdown-item" href="#">Layanan Pasar & Sosial</a>
																<ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item" href="feature-headers-overview.html">Adminitrasi Pasar</a></li>
                                                                    <li><a class="dropdown-item" href="feature-headers-overview.html">Mobil siaga</a></li>
                                                                    <li><a class="dropdown-item" href="feature-headers-overview.html">Keluhan Warga</a></li>
                                                                </ul>
                                                                <li class="dropdown-submenu">
																<a class="dropdown-item" href="#">Layanan Online</a>
																<ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item" href="feature-headers-overview.html">Informasi Pasar Kerja</a></li>
                                                                    <li><a class="dropdown-item" href="feature-headers-overview.html">Informasi Perizinan</a></li>
                                                                    <li><a class="dropdown-item" href="feature-headers-overview.html">Layanan kependidikan</a></li>
                                                                    <li><a class="dropdown-item" href="feature-headers-overview.html">Daftar tlp.Penting</a></li>
                                                                </ul>
                                                        </ul>
													</li>
													<li>
				...
				<div class="slider-container rev_slider_wrapper" style="height: 100vh;">
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1140, 'gridheight': 800, 'responsiveLevels': [4096,1200,992,500]}">
						...
						<li class="slide-overlay" data-transition="fade">
								<img src="<?= base_url()?>/assets2/img/blank.gif"  
									alt=""
								...
								<div class="rs-background-video-layer" 
									...
									data-videomp4="<?= base_url()?>/assets2/video/tugu.mp4" 
								...
								<div class="tp-caption"
									...
									data-transform_idle="opacity:0.2;s:500;" style="z-index: 5;"><img src="<?= base_url()?>/assets2/img/slides/slide-title-border.png" alt=""></div>
								...
								<div class="tp-caption font-weight-extra-bold text-color-light negative-ls-1"
									...
									data-lineheight="['55','55','55','95']" style="z-index: 5;">SISTEM INFORMASI MANAJEMEN DESA</div>
							...
							<li class="" data-transition="fade">
								<img src="<?= base_url()?>/assets2/img/sawah2.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
								...
								<div class="owl-carousel owl-theme mb-0" data-plugin-options="{'items': 4, 'margin': 35, 'loop': false}">
										...
										<a href="ajax/portfolio-ajax-project.html" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="<?= base_url()?>/assets2/img/projects/project.jpg" class="img-fluid border-radius-0" alt="">
									...
									<div class="portfolio-item">
										<a href="ajax/portfolio-ajax-project-1.html" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<span class="owl-carousel owl-theme dots-inside m-0" data-plugin-options="{'items': 1, 'margin': 20, 'animateOut': 'fadeOut', 'autoplay': true, 'autoplayTimeout': 3000}"><span><img src="<?= base_url()?>/assets2/img/projects/project-1.jpg" class="img-fluid border-radius-0" alt=""></span><span><img src="<?= base_url()?>/assets2/img/projects/project-1-2.jpg" class="img-fluid border-radius-0" alt=""></span></span>
													<span class="thumb-info-title">
									...
									<div class="portfolio-item">
										<a href="ajax/portfolio-ajax-project-2.html" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="<?= base_url()?>/assets2/img/projects/project-2.jpg" class="img-fluid border-radius-0" alt="">
													<span class="thumb-info-title">
									...
									<div class="portfolio-item">
										<a href="ajax/portfolio-ajax-project-3.html" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="<?= base_url()?>/assets2/img/projects/project-27.jpg" class="img-fluid border-radius-0" alt="">
													<span class="thumb-info-title">
									...
									<div class="portfolio-item">
										<a href="ajax/portfolio-ajax-project-4.html" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="<?= base_url()?>/assets2/img/projects/project-4.jpg" class="img-fluid border-radius-0" alt="">
													<span class="thumb-info-title">
									...
									<div class="portfolio-item">
										<a href="ajax/portfolio-ajax-project-5.html" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="<?= base_url()?>/assets2/img/projects/project-5.jpg" class="img-fluid border-radius-0" alt="">
													<span class="thumb-info-title">
									...
									<div class="portfolio-item">
										<a href="ajax/portfolio-ajax-project-6.html" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="<?= base_url()?>/assets2/img/projects/project-6.jpg" class="img-fluid border-radius-0" alt="">
													<span class="thumb-info-title">
									...
									<div class="portfolio-item">
										<a href="ajax/portfolio-ajax-project-7.html" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="<?= base_url()?>/assets2/img/projects/project-7.jpg" class="img-fluid border-radius-0" alt="">
													<span class="thumb-info-title">
									...
									<div class="portfolio-item">
										<a href="" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="<?= base_url()?>/assets2/img/projects/project-23.jpg" class="img-fluid border-radius-0" alt="">
													<span class="thumb-info-title">
									...
									<div class="portfolio-item">
										<a href="" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="<?= base_url()?>/assets2/img/projects/project-24.jpg" class="img-fluid border-radius-0" alt="">
													<span class="thumb-info-title">
									...
									<div class="portfolio-item">
										<a href="" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="<?= base_url()?>/assets2/img/projects/project-25.jpg" class="img-fluid border-radius-0" alt="">
													<span class="thumb-info-title">
									...
									<div class="portfolio-item">
										<a href="" data-ajax-on-modal>
											<span class="thumb-info thumb-info-lighten">
												<span class="thumb-info-wrapper">
													<img src="<?= base_url()?>/assets2/img/projects/project-26.jpg" class="img-fluid border-radius-0" alt="">
													<span class="thumb-info-title">
					...
					<div class="container">
						...
						<div class="row text-center py-3 my-4">
							<div class="owl-carousel owl-theme carousel-center-active-item carousel-center-active-item-style-2 mb-0" data-plugin-options="{'responsive': {'0': {'items': 1}, '476': {'items': 1}, '768': {'items': 5}, '992': {'items': 7}, '1200': {'items': 7}}, 'autoplay': true, 'autoplayTimeout': 3000, 'dots': false}">
								<div>
									<img class="img-fluid" src="<?= base_url()?>/assets2/img/logos/logo-light-1.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="<?= base_url()?>/assets2/img/logos/logo-light-2.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="<?= base_url()?>/assets2/img/logos/logo-light-3.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="<?= base_url()?>/assets2/img/logos/logo-light-4.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="<?= base_url()?>/assets2/img/logos/logo-light-5.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="<?= base_url()?>/assets2/img/logos/logo-light-6.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="<?= base_url()?>/assets2/img/logos/logo-light-4.png" alt="">
								</div>
					...
					<div class="row pb-5 mb-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
							...
							<span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
								<span class="thumb-info-wrapper">
									<a href="about-me.html">
										<img src="<?= base_url()?>/assets2/img/team/team-1.jpg" class="img-fluid" alt="">
									</a>
								</span>
						...
						<div class="col-sm-6 col-lg-3 mb-4 mb-lg-0">
							<span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
								<span class="thumb-info-wrapper">
									<a href="about-me.html">
										<img src="<?= base_url()?>/assets2/img/team/team-2.jpg" class="img-fluid" alt="">
									</a>
								</span>
								<span class="thumb-info-caption">
						...
						<div class="col-sm-6 col-lg-3 mb-4 mb-sm-0">
							<span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
								<span class="thumb-info-wrapper">
									<a href="about-me.html">
										<img src="<?= base_url()?>/assets2/img/team/team-3.jpg" class="img-fluid" alt="">
									</a>
								</span>
								<span class="thumb-info-caption">
						...
						<div class="col-sm-6 col-lg-3">
							<span class="thumb-info thumb-info-hide-wrapper-bg thumb-info-no-zoom">
								<span class="thumb-info-wrapper">
									<a href="about-me.html">
										<img src="<?= base_url()?>/assets2/img/team/team-4.jpg" class="img-fluid" alt="">
									</a>
								</span>
								<span class="thumb-info-caption">
